"""
A) Write a Python program for Handling Missing Value. Replace missing value of salary, age column 
with mean of that column.(Use Data.csv file).[5]
B) Write a Python program to generate a line plot of name Vs salary.[5]
C) Download the heights and weights dataset and load the dataset from a given csv file into a 
